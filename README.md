...
DeployBot is a Python terminal app for discovering devices on a local network and deploying sibling apps to them over SSH-compatible tooling. It now ships with both a command-line interface and a full TUI.

## Commands

- `deploybot -help`: print the available features and commands.
- `deploybot-tui`: launch the terminal UI for the same DeployBot workflows.
